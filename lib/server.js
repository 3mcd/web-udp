  ...
  createClass(Broker, [
    {
      ...
      value: function register(transport) {
        ...
        transport.subscribe(function(message) {
          return _this2._onMessage(message, route);
        });
        transport.send({
          type: "ROUTE",
          route: route
...
var RTCPeer = (function() {
  function RTCPeer(options) {
    ...
    this._onSignalingStateChange = function() {
      ...
      value: function channel(id) {
        ...
        return new Promise(function(resolve) {
          var handle = function handle() {
            var channel = (_this2._channels[
              dc.label
            ] = new DataChannel({ dc: dc }));
            resolve(channel);
...
var RTCConnectionProvider = (function() {
  function RTCConnectionProvider(options) {
    ...
    var transport = options.transport,
      ...
      onConnection =
        _options$onConnection === undefined
          ? function(connection) {}
          : _options$onConnection;
...
var Client = (function() {
  function Client(options) {
    ...
    if (options.provider) {
      ...
      transport = new WebSocketTransport(new WebSocket(_url));
    ...
    this._route = new Promise(function(resolve) {
      var handle = function handle(message) {
  ...
  createClass(Server, [
    {
      ...
      value: function client(onConnection) {
        ...
        var signaling = new WebSocket$1.Server({
          server: this._server
        });
